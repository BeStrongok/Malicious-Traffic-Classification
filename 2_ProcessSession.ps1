...
$SESSIONS_COUNT_LIMIT_MAX = 50000
$TRIMED_FILE_LEN = 784
...
#             Copy-Item $train -destination $path_train
             $path_file = "3_ProcessedSession\FilteredSession\$($d.Name)"
             New-Item -Path $path_file -ItemType Directory -Force
             Copy-Item $files -destination $path_file
        }
    }
...
#     $paths = @(('3_ProcessedSession\FilteredSession\Train', '3_ProcessedSession\TrimedSession\Train'), ('3_ProcessedSession\FilteredSession\Test', '3_ProcessedSession\TrimedSession\Test'))
    $p = @(('3_ProcessedSession\FilteredSession', '3_ProcessedSession\TrimedSession'))
